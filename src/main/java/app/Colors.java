...
public class Colors {
     ...
     * Цвет прямоугольника
     */
     public static final int RECTANGLE_COLOR = Misc.getColor(255, 0, 0, 0);
    /**
     * Цвет вершин прямоугольника
     */
     public static final int TOPS_COLOR = Misc.getColor(255,255,0,0);
    /**
     * Цвет точек, через которые мы проводим прямую
     */
    public static final int S_POINTS_COLOR = Misc.getColor(255,255,215,0);
